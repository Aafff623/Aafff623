...
<p align="center">
  <img src="./assets/brand-threetwoa.svg" alt="threetwoa - Code less, Architect more." width="620" />
</p>

<table width="100%">
  <tr>
    <td width="64%" valign="top">
      <p>I'm a sophomore Software Engineering student at North University of China, exploring Agentic Coding, Web3, and reusable AI engineering workflows.</p>
      <p>I build across backend systems, frontend demos, automation pipelines, MCP, and Skills — with a focus on turning messy ideas into shippable projects.</p>
      <ul>
        <li><b>Identity:</b> AI Coding Workflow Builder · Web3 Hackathon Builder · Software Engineering Student</li>
        <li><b>Core Approach:</b> GPT for planning, Claude Code for execution, Codex for review, and human judgment to close the loop.</li>
      </ul>
    </td>
    <td width="36%" align="center" valign="middle">
      <img src="./assets/hero-knight.png" width="280" alt="threetwoa hero" />
    </td>
  </tr>
</table>
